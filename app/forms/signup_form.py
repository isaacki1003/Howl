...
class SignUpForm(FlaskForm):
    first_name = StringField('first_name', validators=[DataRequired('Please enter your first name.'), Length(max=10, message='Your first name must be less than 10 characters.')])
    last_name = StringField('last_name', validators=[DataRequired('Please enter your last name.'), Length(max=10, message='Your last name must be less than 10 characters.')])
