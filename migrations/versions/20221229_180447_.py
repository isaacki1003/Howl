...
Revision ID: ed9c773f9c23
Revises:
Create Date: 2022-12-29 18:04:47.069733
...
def upgrade():
    ...
    sa.Column('hashed_confirm_password', sa.String(length=255), nullable=False),
